  ...
  return (
    <div className="h-full w-full">
      ...
      <div className="cloud-bg">
        ...
        <div className="absolute top-[-2%] left-[-5%] w-72 h-72 z-0 opacity-90">
        ...
        {/* Top Right Cluster */}
        <div className="absolute top-[-5%] right-[-10%] w-72 h-72 z-0 opacity-90">
        ...
        <div className="absolute top-[38%] left-[-15%] w-64 h-64 z-0 opacity-80">
        ...
        <div className="absolute top-[42%] right-[-12%] w-64 h-64 z-0 opacity-80">
          ...
          <div className="fixed bottom-0 left-0 right-0 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] z-50">
            <div className="max-w-md mx-auto flex justify-center items-center gap-10">
              ...
              <button 
                ...
                className={`p-3 rounded-full transition-all ${screen === 'home' && !habitsExpanded ? 'nav-pill-active' : 'bg-white/90'}`}
              >
                <svg className={`w-6 h-6 ${screen === 'home' && !habitsExpanded ? 'text-orange-500' : 'text-gray-400'}`} fill={screen === 'home' && !habitsExpanded ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              ...
              <button 
                ...
                className={`p-3 rounded-full transition-all ${screen === 'home' && habitsExpanded ? 'nav-pill-active' : 'bg-white/90'}`}
              >
                <svg className={`w-6 h-6 ${screen === 'home' && habitsExpanded ? 'text-orange-500' : 'text-gray-400'}`} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              ...
              <button 
                ...
                className={`p-3 rounded-full transition-all ${screen === 'social' ? 'nav-pill-active' : 'bg-white/90'}`}
              >
                <svg className={`w-6 h-6 ${screen === 'social' ? 'text-orange-500' : 'text-gray-400'}`} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
