        ...
        {showMainNav && (
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] z-50">
            <div className="max-w-md mx-auto flex justify-center items-center gap-10">
              ...
              >
                <svg
                  className={`w-6 h-6 transition-transform duration-150 ease-out ${screen === 'home' && !habitsExpanded ? 'text-[color:var(--accent-solid)] scale-110' : 'text-gray-400'}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={screen === 'home' && !habitsExpanded ? 2.2 : 1.6}
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  className={`w-6 h-6 transition-transform duration-150 ease-out ${screen === 'social' ? 'text-[color:var(--accent-solid)] scale-110' : 'text-gray-400'}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={screen === 'social' ? 2.2 : 1.6}
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  className={`w-6 h-6 transition-transform duration-150 ease-out ${screen === 'profile' ? 'text-[color:var(--accent-solid)] scale-110' : 'text-gray-400'}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={screen === 'profile' ? 2.2 : 1.6}
                  viewBox="0 0 24 24"
                >
