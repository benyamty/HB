          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] z-50">
            <div className="max-w-md mx-auto flex justify-center items-center gap-12">
              ...
              <button 
                ...
                className="p-2"
              >
                <svg className={`w-6 h-6 ${screen === 'home' && !habitsExpanded ? 'text-pink-500' : 'text-gray-400'}`} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="p-2"
              >
                <svg className={`w-6 h-6 ${screen === 'social' ? 'text-pink-500' : 'text-gray-400'}`} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
