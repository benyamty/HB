        ...
        {showMainNav && (
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] z-50">
            <div className="max-w-md mx-auto flex justify-center items-center gap-10">
              ...
              >
                <svg
                  className={`w-6 h-6 ${screen === 'home' && !habitsExpanded ? 'text-[color:var(--accent-solid)]' : 'text-gray-400'}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={screen === 'home' && !habitsExpanded ? 2.8 : 2}
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  className={`w-6 h-6 ${screen === 'social' ? 'text-[color:var(--accent-solid)]' : 'text-gray-400'}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={screen === 'social' ? 2.8 : 2}
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  className={`w-6 h-6 ${screen === 'profile' ? 'text-[color:var(--accent-solid)]' : 'text-gray-400'}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={screen === 'profile' ? 2.8 : 2}
                  viewBox="0 0 24 24"
                >
